...
export const Lens = ({
  ...
  const handleTouchMove = (e) => {
    ...
    setMousePosition({ x, y });
    setIsHovering(true); // Set hovering state to true on touch
  };
  ...
  return (
    <div
      ...
      onTouchStart={() => setIsHovering(true)} // Start hovering on touch
      onTouchEnd={() => setIsHovering(false)} // End hovering on touch
